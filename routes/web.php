...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('/contacts', 'contact')->name('contact.view');
    Route::get('/quote', 'quotePage')->name('quote.view');
    Route::get('/about', 'about')->name('about');
    Route::get('/our-story', 'story')->name('story');
    Route::get('/commitment', 'commitment')->name('commitment');
    ...
    Route::get('/products', 'all_product')->name('all.product');
