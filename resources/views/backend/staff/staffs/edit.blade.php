            ...
            <form action="{{ route('staffs.update', $staff->id) }}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{translate('facebook link')}}" value="{{ $staff->facebook }}" id="facebook" name="facebook" class="form-control" >
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-from-label" for="twitter">{{translate('Twitter')}}</label>
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{translate('twitter link')}}" value="{{ $staff->twitter }}" id="twitter" name="twitter" class="form-control" >
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-from-label" for="linkedin">{{translate('Linked In')}}</label>
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{translate('linkedin link')}}" value="{{ $staff->linkedin }}"  id="linkedin" name="linkedin" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
