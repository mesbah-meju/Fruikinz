            ...
            <div class="col-lg-4">
                <div class="ltn__contact-address-item ltn__contact-address-item-3 box-shadow">
                    <div class="ltn__contact-address-icon">
                        <img src="{{ static_asset('assets/img/icons/10.png') }}" alt="Email Icon">
                    </div>
                    <h3>Email Address</h3>
                    <p><a href="mailto:{{ get_setting('contact_email') }}" class="fs-13 text-gray-darkt hov-text-primary">{{ get_setting('contact_email') }}</a></p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="ltn__contact-address-item ltn__contact-address-item-3 box-shadow">
                    <div class="ltn__contact-address-icon">
                        <img src="{{ static_asset('assets/img/icons/11.png') }}" alt="Phone Icon">
                    </div>
                    <h3>Phone Number</h3>
                    <p class="fs-13 text-gray-darkt hov-text-primary">{{ get_setting('contact_phone') }}</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="ltn__contact-address-item ltn__contact-address-item-3 box-shadow">
                    <div class="ltn__contact-address-icon">
                        <img src="{{ static_asset('assets/img/icons/12.png') }}" alt="Address Icon">
                    </div>
                    <h3>Office Address</h3>
                    <p class="fs-13 text-gray-darkt hov-text-primary">{{ get_setting('contact_address', null, App::getLocale()) }}</p>
                </div>
            </div>
        </div>
    </div>
