                                    ...
                                    <div class="ltn__shop-details-large-img">
                                        <div class="single-large-img">
                                            <a href="img/product/1.png" data-rel="lightcase:myCollection">
                                                <img src="{{ static_asset('assets/img/banner/bg1.png')}}" alt="Image">
                                            </a>
                                        </div>
                                        <div class="single-large-img">
                                                ...
                                                <li>
                                                    <div class="ltn__comment-item clearfix">
                                                        <div class="ltn__commenter-img">
                                                            <img src="{{ static_asset('assets/img/banner/bg1.png')}}.jpg" alt="Image">
                                                        </div>
                                ...
                                <li>
                                    <div class="top-rated-product-item clearfix">
                                        <div class="top-rated-product-img">
                                            <a href="product"><img src="{{ static_asset('assets/img/banner/bg1.png')}}" alt="#"></a>
                                        </div>
                                        <div class="top-rated-product-info">
                                            ...
                                            <h6><a href="product">Mixel Solid Seat Cover</a></h6>
                                            <div class="product-price">
                                                <span>$49.00</span>
                                                <del>$65.00</del>
                                            </div>
                                ...
                                <li>
                                    <div class="top-rated-product-item clearfix">
                                        ...
                                        <div class="top-rated-product-info">
                                            ...
                                            <h6><a href="product">BBQ Jackfruit Chips</a></h6>
                                            <div class="product-price">
                                                <span>$49.00</span>
                                                <del>$65.00</del>
                                            </div>
                                ...
                                <li>
                                    <div class="top-rated-product-item clearfix">
                                        ...
                                        <div class="top-rated-product-info">
                                            ...
                                            <h6><a href="product">Coil Spring Conversion</a></h6>
                                            <div class="product-price">
                                                <span>$49.00</span>
                                                <del>$65.00</del>
                                            </div>
                ...
                <div class="col-lg-12">
                    <div class="ltn__product-item ltn__product-item-3 text-center">
                        ...
                        <div class="product-info">
                            ...
                            <h2 class="product-title"><a href="product">Red Hot Tomato</a></h2>
                            <div class="product-price">
                                <span>$149.00</span>
                                <del>$162.00</del>
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="ltn__product-item ltn__product-item-3 text-center">
                        ...
                        <div class="product-info">
                            ...
                            <h2 class="product-title"><a href="product">BBQ Jackfruit Chips</a></h2>
                            <div class="product-price">
                                <span>$62.00</span>
                                <del>$85.00</del>
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="ltn__product-item ltn__product-item-3 text-center">
                        ...
                        <div class="product-info">
                            ...
                            <h2 class="product-title"><a href="product">Orange Fresh Juice</a></h2>
                            <div class="product-price">
                                <span>$75.00</span>
                                <del>$92.00</del>
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="ltn__product-item ltn__product-item-3 text-center">
                        ...
                        <div class="product-info">
                            ...
                            <h2 class="product-title"><a href="product">Poltry Farm Meat</a></h2>
                            <div class="product-price">
                                <span>$78.00</span>
                                <del>$85.00</del>
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="ltn__product-item ltn__product-item-3 text-center">
                        ...
                        <div class="product-info">
                            ...
                            <h2 class="product-title"><a href="product">Fresh Butter Cake</a></h2>
                            <div class="product-price">
                                <span>$150.00</span>
                                <del>$180.00</del>
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="ltn__product-item ltn__product-item-3 text-center">
                        ...
                        <div class="product-info">
                            ...
                            <h2 class="product-title"><a href="product">Orange Sliced Mix</a></h2>
                            <div class="product-price">
                                <span>$150.00</span>
                                <del>$180.00</del>
                            </div>
                    ...
                    <div class="ltn__feature-item-box-wrap ltn__border-between-column white-bg">
                        <div class="row">
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="ltn__feature-item ltn__feature-item-8">
                                    <div class="ltn__feature-icon">
                                        <img src="{{ static_asset('assets/img/banner/bg1.png')}}g/11.png" alt="#">
                                    </div>
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="ltn__feature-item ltn__feature-item-8">
                                    <div class="ltn__feature-icon">
                                        <img src="{{ static_asset('assets/img/banner/bg1.png')}}g/12.png" alt="#">
                                    </div>
                                    <div class="ltn__feature-info">
                                        <h4>Handmade</h4>
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="ltn__feature-item ltn__feature-item-8">
                                    <div class="ltn__feature-icon">
                                        <img src="{{ static_asset('assets/img/banner/bg1.png')}}g/13.png" alt="#">
                                    </div>
                                    <div class="ltn__feature-info">
                                        <h4>Natural Food</h4>
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="ltn__feature-item ltn__feature-item-8">
                                    <div class="ltn__feature-icon">
                                        <img src="{{ static_asset('assets/img/banner/bg1.png')}}g/14.png" alt="#">
                                    </div>
                                    <div class="ltn__feature-info">
