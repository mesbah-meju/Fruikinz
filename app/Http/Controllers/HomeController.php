...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.index', compact('featured_categories', 'lang','recent_blogs'));
    }
    ...
    {
        return view('frontend.quote_page');
    }
    ...
    public function about()
    {
        ...
        $recent_blogs = Blog::where('status', 1)->orderBy('created_at', 'desc')->limit(9)->get();
        return view('frontend.about',compact('members','recent_blogs','lang'));
    }
    ...
    public function story()
    {
        $lang = get_system_language() ? get_system_language()->code : null;
        $members = Staff::get();
        return view('frontend.story',compact('members', 'lang'));
    }
    public function commitment()
    {
        $lang = get_system_language() ? get_system_language()->code : null;
        $members = Staff::get();
        return view('frontend.commitment',compact('members', 'lang'));
    }
    ...
    public function all_product(Request $request){
        ...
        return view('frontend.all_product',compact('products')); 
    }
